...
def scan_source(list_url)
  ...
  result_properties.each do |property|
    property = {
      ...
      link: 'https://www.city.ueda.nagano.jp/' + property.css('a')[0].attributes["href"].value
    }
...
list_url = "https://www.city.ueda.nagano.jp/akiyabank/search.php?hid_flg_search=1&page=1&k_syozaichi%5B%5D=1&k_syozaichi%5B%5D=2&k_syozaichi%5B%5D=3&k_syozaichi%5B%5D=4&k_syozaichi%5B%5D=5&k_syozaichi%5B%5D=0"
